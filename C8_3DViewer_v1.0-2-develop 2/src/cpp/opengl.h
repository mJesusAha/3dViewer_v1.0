...
class Opengl : public QOpenGLWidget {
 ...
 public:
  ...
  float pointSize = 1.0;
  int type_line = 0;      // 0 - сплошная, 1 - пунктирная
  int displayMethod = 0;  // 0 - круг, 1 - квадрат, 2 - нет
  int typeProjection = 0;
  QColor back_color = QColor::fromRgbF(0.22, 0.22, 0.22, 1);
  QColor edge_color = QColor::fromRgbF(1, 1, 1, 1);
  QColor vertex_color = QColor::fromRgbF(1, 1, 1, 1);
  coord coord = {-1, 1, -1, 1, -1, 1};
